...
def generate_docs():
    """Genera la documentación del proyecto usando una plantilla Jinja2."""
    issues, milestones = load_data()
    
    # Template para la documentación
    template_str = """---
layout: default
title: Documentación Técnica del Servicio de Programa del Día
---

# Documentación Técnica del Servicio de Programa del Día
