...
# El pom.xml define <finalName>eterea.programa-dia-service</finalName>
COPY --from=build /app/target/eterea.programa-dia-service.jar ./eterea.programa-dia-service.jar

# Cambiamos al usuario no privilegiado
USER appuser

# Comando para ejecutar la aplicación
ENTRYPOINT ["java", "-jar", "eterea.programa-dia-service.jar"]
